...
/// struct for passing parameters to the method [`list_stoves`]
#[derive(Clone, Debug, Default)]
pub struct ListStovesParams {
    /// Session cookie
    pub connect_period_sid: String
}
...
pub async fn list_stoves(configuration: &configuration::Configuration, params: ListStovesParams) -> Result<String, Error<ListStovesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListStovesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn login(configuration: &configuration::Configuration, params: LoginParams) -> Result<(), Error<LoginError>> {
    let local_var_configuration = configuration;
...
pub async fn logout(configuration: &configuration::Configuration, params: LogoutParams) -> Result<(), Error<LogoutError>> {
    let local_var_configuration = configuration;
...
pub async fn stove_controls(configuration: &configuration::Configuration, params: StoveControlsParams) -> Result<(), Error<StoveControlsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/client/{stoveId}/controls", local_var_configuration.base_path, stoveId=crate::apis::urlencode(stove_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if let Some(local_var_param_value) = frost_protection_temperature {
        local_var_form_params.insert("frostProtectionTemperature", local_var_param_value.to_string());
    }
    ...
    if let Some(local_var_param_value) = heating_times_active_for_comfort {
        local_var_form_params.insert("heatingTimesActiveForComfort", local_var_param_value.to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StoveControlsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn stove_status(configuration: &configuration::Configuration, params: StoveStatusParams) -> Result<crate::models::StoveStatus, Error<StoveStatusError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/client/{stoveId}/status", local_var_configuration.base_path, stoveId=crate::apis::urlencode(stove_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StoveStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

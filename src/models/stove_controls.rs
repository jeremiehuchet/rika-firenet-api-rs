...
pub struct StoveControls {
    ...
    #[serde(rename = "convectionFan1Active", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "convectionFan1Level", skip_serializing_if = "Option::is_none")]
    pub convection_fan1_level: Option<i32>,
    #[serde(rename = "convectionFan2Active", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "convectionFan2Level", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "frostProtectionActive", skip_serializing_if = "Option::is_none")]
    pub frost_protection_active: Option<bool>,
    #[serde(rename = "frostProtectionTemperature", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "heatingTimesActiveForComfort", skip_serializing_if = "Option::is_none")]
